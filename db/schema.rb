...
ActiveRecord::Schema.define(version: 20170906094321) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "username"
    t.string   "description",            default: "Hello world, this is your list. You get only one so treat it with care. Good luck!🚀"
